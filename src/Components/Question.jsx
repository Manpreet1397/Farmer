    ...
    <section className="mx-auto max-w-7xl pb-4 md:px-0">
      <div>
        <div className="mx-auto max-w-3xl space-y-4 ">
          <div className="border-2 rounded-3xl border-gray-800 shadow-lg transition-all duration-200">
            <button
              type="button"
              className="flex w-full items-center justify-between px-4  text-yellow-500 py-5 sm:p-6"
            >
              <h1 className="flex text-lg font-semibold text-white w-full" onClick={()=>{
                if(!showAnswer){
